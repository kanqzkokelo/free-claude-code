...
class Settings(BaseSettings):
    ...
    # ==================== Unlimited AI Config ====================
    unlimited_ai_api_key: str = Field(default="", validation_alias="UNLIMITED_AI_API_KEY")
    ...
    # ==================== Google Cloud Code Antigravity ====================
    # Uses Google OAuth (not API keys). Set via `fcc-antigravity-login`.
    antigravity_model: str = Field(
        default="default", validation_alias="ANTIGRAVITY_MODEL"
    )
