...
# Google Cloud Code Antigravity backend (Gemini generateContent API)
ANTIGRAVITY_GENERATE_URL = "https://cloudcode-pa.googleapis.com/v1internal:generateContent"
...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "unlimited_ai": ProviderDescriptor(
        provider_id="unlimited_ai",
        transport_type="anthropic_messages",
        credential_env="UNLIMITED_AI_API_KEY",
        credential_attr="unlimited_ai_api_key",
        capabilities=("chat", "streaming", "tools", "thinking", "native_anthropic"),
    ),
    "antigravity": ProviderDescriptor(
        provider_id="antigravity",
        transport_type="openai_chat",
        # Antigravity uses Google OAuth (not API keys). Tokens are loaded from disk.
        static_credential="antigravity-oauth",
